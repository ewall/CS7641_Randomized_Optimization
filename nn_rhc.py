...
# prep output data
labels = ['problem', 'max_attempts', 'max_iters', 'restarts', 'run_time', 'error', 'kappa']
results_list = []
	...
	for attempts in (25,):
		for restarts in (10,):
			...
			print("\nRUN: max_attempts=", attempts,
			      ...
			      "\nconfusion matrix=\n", y_test_confusion,
			      "\nRUN TIME=", run_time)
			results_list.append((EXPERIMENT_NAME, attempts, iterations, restarts, run_time, y_test_error, y_test_kappa))
